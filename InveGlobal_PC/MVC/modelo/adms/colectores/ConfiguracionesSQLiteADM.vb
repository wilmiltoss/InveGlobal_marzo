...
#Region "Miembros de ADMbase"
    ...
    Public Overrides Function lAgregar(ByVal oConfigParam As OTDbase) As List(Of Object)
        ...
        Try
            ...
            Dim cUpdate As String = String.Format(_Insert_sql, oConfig.nCantidadMaxima, oConfig.nConDecimales, oConfig.nIdInventario, oConfig.nIpSqlServer)
    ...
    Public Overrides Function lActualizar(ByVal oConfigParam As OTDbase) As List(Of Object)
        ...
        Try
            ...
            'ensamblamos la sentencia de actualizacion
            Dim cUpdate As String = String.Format(_Update_sql, oConfig.nCantidadMaxima,
                                                  oConfig.nConDecimales,
                                                  oConfig.nIdInventario,
                                                  oConfig.nIpSqlServer)
