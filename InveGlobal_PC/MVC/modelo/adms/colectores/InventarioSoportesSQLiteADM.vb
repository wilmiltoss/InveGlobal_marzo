...
Public Class InventarioSoportesSQLiteADM
    Inherits ADMbase

#Region "ATRIBUTOS"

    Public Const NOMBRE_CLASE As String = "InventarioSoportesSQLiteADM"
...
#Region "CONSTRUCTORES"
    ...
    Public Sub New(ByVal ApModeloParam As ApModeloSQLite)
        ...
        Set_tabla(New InventarioSoportesSQLiteTBL())
...
#Region "Miembros de ADMbase"
    ...
    Public Overrides Function lAgregar(ByVal oInvenSoporteParam As OTDbase) As List(Of Object)
        ...
        Try
            ...
            Dim oInvenSoporte As InventarioSoporteSQLiteOTD = CType(oInvenSoporteParam, InventarioSoporteSQLiteOTD)

            'ensamblamos la sentencia de actualizacion
            Dim cInsert As String = String.Format(_Insert_sql, oInvenSoporte.nIdInventarioSoporte, oInvenSoporte.nIdInventario,
                                            oInvenSoporte.nIdClave, oInvenSoporte.nIdSoporte, oInvenSoporte.nNroSoporte,
                                          oInvenSoporte.nNroTipoSoporte, oInvenSoporte.cDescripcionSoporte, oInvenSoporte.nConteo1,
                                            oInvenSoporte.nConteo2, oInvenSoporte.nConteo3, oInvenSoporte.nIdLocaciones)
...
#Region "ESPECIFICOS"
    ...
    Public Function lCrear_tabla() As List(Of Object)
        ...
        Try
            ...
            lResultado = _oConector.lEjecutar_sentencia(InventarioSoportesSQLiteTBL.SQL_DROP_TABLA)

            'si se ejecuto correctamente, creamos de vuelta la tabla
            If lResultado(0).Equals(1) Then lResultado = _oConector.lEjecutar_sentencia(InventarioSoportesSQLiteTBL.SQL_CREAR_TABLA)
