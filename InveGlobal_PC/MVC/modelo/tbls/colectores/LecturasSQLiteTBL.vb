...
#Region "ATRIBUTOS"
    ...
    Public Const SQL_CREAR_TABLA As String = "CREATE TABLE LECTURAS(ID_LOCACION INTEGER, NRO_CONTEO INTEGER, ID_SOPORTE INTEGER " _
                                                ...
                                                + ", SCANNING TEXT, CANTIDAD FLOAT, ID_USUARIO INT, ID_INVENTARIO INT, PRIMARY KEY (ID_LOCACION" _
                                                + ", NRO_CONTEO, ID_SOPORTE, NRO_SOPORTE, ID_LETRA_SOPORTE, NIVEL, METRO, SCANNING, ID_INVENTARIO))"
    ...
    Public Shared ID_INVENTARIO As New Campo("ID_INVENTARIO", 10, False, GetType(Integer))
...
#Region "CONSTRUCTORES"
    ...
    Public Sub New()
        ...
        CAMPOS = New Campo() {ID_LOCACION, NRO_CONTEO, ID_SOPORTE, NRO_SOPORTE, ID_LETRA_SOPORTE _
                              , NIVEL, METRO, SCANNING, CANTIDAD, ID_USUARIO, ID_INVENTARIO}
