...
#Region "ATRIBUTOS"
    ...
    Public Shared IP_SQL_SERVER As New Campo("IP_SQL_SERVER", 0, False, GetType(String))
...
#Region "CONSTRUCTORES"
    ...
    Public Sub New()
        ...
        CAMPOS = New Campo() {CANTIDAD_MAXIMA, CON_DECIMALES, ID_INVENTARIO, IP_SQL_SERVER}
