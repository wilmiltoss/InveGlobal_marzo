...
#Region "ATRIBUTOS"
    ...
    Private __oInventarioSoporteADM As InventarioSoportesSQLiteADM
...
#Region "ADMINISTRADORES"
    ...
    ''' <summary>
    ''' Devuelve una instancia del administrador de operaciones sobre la tabla INVENTARIO_SOPORTE
    ''' </summary>
    ''' <value>Nothing</value>
    ''' <returns>Instancia del administrador de operaciones</returns>
    ''' <remarks></remarks>
    Public ReadOnly Property InventarioSoporte_ADM() As InventarioSoportesSQLiteADM
        Get
            If __oInventarioSoporteADM Is Nothing Then __oInventarioSoporteADM = New InventarioSoportesSQLiteADM(Get_instancia())
            Return __oInventarioSoporteADM
        End Get
    End Property
