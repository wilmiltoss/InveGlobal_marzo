...
Public Class InventarioSoporteOTD
    Inherits OTDbase

    Public Shadows Const NOMBRE_CLASE As String = "InventarioSoporteOTD"
...
#Region "CONSTRUCTORES"
    ...
    Public Sub New(ByVal nIdInventarioSoporteParam As Integer _
        ...
        MyBase.New(nIdInventarioSoporteParam, nIdInventarioParam)
