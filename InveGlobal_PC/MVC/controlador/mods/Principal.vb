...
#Region "DECLARACIONES_VARIABLES_GLOBALES_Y_MODULO"
    ...
    Private cBat_Montaje_usb As String
...
#End Region
    ...
    Public Sub main()
        ...
        'cBat_Montaje_usb = CurDir() & oArchivoConfig.leer_ini("Parametros", "BatMontajeUsb", "\lectura.bat")
        ...
        'ejecutamos el procedimiento de Montaje usb
        'pMontar_Unidad_usb()
    ...
    Private Sub pMontar_Unidad_usb()
        Try

            'ejecutamos el batch de montaje de prueba lectura usb android
            Shell(cBat_Montaje_usb)

        Catch Ex As Exception
            'en caso de error, mensajes de notificacion
            MessageBox.Show("Dispositivo usb android desconectado", "Atencion", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            MessageBox.Show(Ex.Message, "Atencion", MessageBoxButtons.OK, MessageBoxIcon.Error)
